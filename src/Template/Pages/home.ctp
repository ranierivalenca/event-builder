...
<div id="escovandobits" class="section">
  <div class="container">
    <div class="row">
      ...
      <p>O Escovando Bits é para você que tem algum projeto, pesquisa ou conhecimento técnico em temas na área de TI e quer <strong>compatilhar</strong> com a comunidade!
      ...
      <h5 class="text-center">
        <a href="#" data-toggle="modal" data-target="#modal_escovandobits"><span class="fa fa-plus-square"></span> Saiba mais</a>
      </h5>
