...
bd-init:
	@mysql -u root -p -e "DROP DATABASE $(DB); DROP USER '$(USER)'@'localhost'; CREATE DATABASE $(DB); CREATE USER '$(USER)'@'localhost' IDENTIFIED BY '$(PW)'; GRANT ALL PRIVILEGES ON $(DB).* to '$(USER)'@'localhost';"
